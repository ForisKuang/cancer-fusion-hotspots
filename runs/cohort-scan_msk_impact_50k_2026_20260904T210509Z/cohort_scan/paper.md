...
This manuscript synthesizes a genome-wide fusion-hotspot cohort scan of msk_impact_50k_2026: 3919 genes carried at least one structural-variant record in the cohort, of which 544 passed the >= 5-distinct-patient recurrence gate. All 544 gated genes were attempted: 4 using hand-curated gene configs and 520 auto-configured, with 20 gated-in gene(s) left unresolvable; 493 of the 544 attempted genes were successfully analyzed with the full registered algorithm suite. 4 genes reached genome-wide Benjamini-Hochberg FDR significance (q < 0.05): NTRK3 (58 events, 94.8% in-frame, 94.8% domain-retained, Fisher p=0.0695489, q=7.66319e-09); ROS1 (122 events, 59.0% in-frame, 87.7% domain-retained, Fisher p=0.214047, q=0.000207674); ETV6 (90 events, 71.1% in-frame, 75.6% domain-retained, Fisher p=5.12326e-06, q=0.00218934); FLI1 (118 events, 61.9% in-frame, 5.9% domain-retained, Fisher p=0.988837, q=0.00770159). 15 additional genes form a highly ranked non-FDR-significant tier flagged for targeted follow-up (see Honorable mentions, below).

## Methods

Structural-variant records were retrieved from the msk_impact_50k_2026 cBioPortal study and gated to genes with at least 5 distinct patient(s) carrying a structural-variant record (544 of 3919 genes passed the gate). All 544 gated genes were attempted: 4 using hand-curated gene configs and 520 auto-configured from Genome Nexus canonical-transcript/Pfam-domain data, with 20 gated-in gene(s) left unresolvable; 493 of the 544 attempted genes were successfully analyzed. Each successfully analyzed gene was run through the algorithm suite recorded for this scan (composite_score, confidence_stats, cutpoint_detection, domain_disruption, domain_retention, exon_retention, frequency, joint_partner). Domain-retention and domain-disruption significance were assessed per gene with Fisher's exact test and a breakpoint-position permutation test; the resulting p-values across the 338 genes that produced at least one computable p-value were jointly corrected with Benjamini-Hochberg false-discovery-rate correction at q < 0.05.

## Results

### Genome-wide summary

Genome-wide summary of 338 scanned genes with an FDR-adjusted q-value, ranked left-to-right by composite evidence score; the dashed line marks the q=0.05 significance threshold, with 4 genes above it.
...
|---|---|---|---|---|---|---|
| NTRK3 | FDR-significant | 58 | 94.83 | 94.83 | 0.06955 | 7.663e-09 |
| ROS1 | FDR-significant | 122 | 59.02 | 87.7 | 0.214 | 0.0002077 |
| ETV6 | FDR-significant | 90 | 71.11 | 75.56 | 5.123e-06 | 0.002189 |
| FLI1 | FDR-significant | 118 | 61.86 | 5.932 | 0.9888 | 0.007702 |
| RET | Honorable mention | 194 | 75.26 | 92.27 | 0.0004197 | 0.09074 |
| FGFR2 | Honorable mention | 136 | 79.41 | 84.56 | 0.0004247 | 0.09074 |
| ALK | Honorable mention | 272 | 83.09 | 95.96 | 0.001917 | 0.2116 |
| EGFR | Honorable mention | 55 | 50.91 | 74.55 | 0.01145 | 0.2368 |
| BRAF | Honorable mention | 179 | 84.36 | 91.06 | 0.01337 | 0.2116 |
| FGFR3 | Honorable mention | 152 | 48.68 | 93.42 | 0.01948 | 0.2116 |
| CDKN2B | Honorable mention | 12 | 16.67 | 16.67 | 0.02222 | 0.3606 |
| NTRK1 | Honorable mention | 78 | 41.03 | 82.05 | 0.04826 | 0.2116 |
| INPPL1 | Honorable mention | 14 | 28.57 | 50 | 0.04895 | 0.4733 |
| CDK12 | Honorable mention | 43 | 16.28 | 37.21 | 0.0677 | 0.2116 |
| NAB2 | Honorable mention | 72 | 34.72 | 68.06 | 0.1126 | 0.2116 |
| KDM5A | Honorable mention | 10 | 30 | 50 | 0.119 | 0.8816 |
| FH | Honorable mention | 16 | 6.25 | 12.5 | 0.1333 | 0.673 |
| FGFR1 | Honorable mention | 23 | 30.43 | 47.83 | 0.1807 | 0.5489 |
| POLD1 | Honorable mention | 16 | 12.5 | 37.5 | 0.1923 | 0.2116 |

### Gene highlights

#### NTRK3 (FDR-significant)

NTRK3 was analyzed across 58 fusion events, 94.8% in-frame and 94.8% domain-retained. Domain-retention Fisher's exact test p=0.0695489 (raw not statistically significant at alpha=0.05). Genome-wide BH-adjusted q=7.66319e-09 (reaches genome-wide FDR significance).
...
ROS1 was analyzed across 122 fusion events, 59.0% in-frame and 87.7% domain-retained. Domain-retention Fisher's exact test p=0.214047 (raw not statistically significant at alpha=0.05). Genome-wide BH-adjusted q=0.000207674 (reaches genome-wide FDR significance).
...
ETV6 was analyzed across 90 fusion events, 71.1% in-frame and 75.6% domain-retained. Domain-retention Fisher's exact test p=5.12326e-06 (raw statistically significant at alpha=0.05). Genome-wide BH-adjusted q=0.00218934 (reaches genome-wide FDR significance).
...
FLI1 was analyzed across 118 fusion events, 61.9% in-frame and 5.9% domain-retained. Domain-retention Fisher's exact test p=0.988837 (raw not statistically significant at alpha=0.05). Genome-wide BH-adjusted q=0.00770159 (reaches genome-wide FDR significance).
...
#### FGFR1 (Honorable mention)

FGFR1 was analyzed across 23 fusion events, 30.4% in-frame and 47.8% domain-retained. Domain-retention Fisher's exact test p=0.180728 (raw not statistically significant at alpha=0.05). Genome-wide BH-adjusted q=0.54888 (does not reach genome-wide FDR significance). Did not survive genome-wide multiple-testing correction (FDR-adjusted q-value at or above the significance threshold), but ranks highly by raw p-value among the non-FDR-significant genes and may warrant targeted follow-up. This is NOT a claim of statistical significance.

![FGFR1 key figure](gene_reports/fgfr1/visualizations/fusion_schematic.svg)

Full per-gene detail: [gene_reports/fgfr1/report.md](gene_reports/fgfr1/report.md)

#### POLD1 (Honorable mention)

POLD1 was analyzed across 16 fusion events, 12.5% in-frame and 37.5% domain-retained. Domain-retention Fisher's exact test p=0.192308 (raw not statistically significant at alpha=0.05). Genome-wide BH-adjusted q=0.211551 (does not reach genome-wide FDR significance). Did not survive genome-wide multiple-testing correction (FDR-adjusted q-value at or above the significance threshold), but ranks highly by raw p-value among the non-FDR-significant genes and may warrant targeted follow-up. This is NOT a claim of statistical significance.

![POLD1 key figure](gene_reports/pold1/visualizations/fusion_schematic.svg)

Full per-gene detail: [gene_reports/pold1/report.md](gene_reports/pold1/report.md)

## Discussion

- Cross-gene Benjamini-Hochberg FDR correction was applied jointly across the 338 genes that produced at least one computable p-value in this scan. This reduces false-positive findings relative to testing each gene in isolation, but is a conservative correction: a real per-gene effect can fail to reach the q < 0.05 threshold once corrected across that full p-value-bearing gene set.
...
|---|---|---|---|---|---|
| NTRK3 | FDR-significant | auto | 58 | 7.663e-09 | [gene_reports/ntrk3/report.md](gene_reports/ntrk3/report.md) |
| ROS1 | FDR-significant | auto | 122 | 0.0002077 | [gene_reports/ros1/report.md](gene_reports/ros1/report.md) |
| ETV6 | FDR-significant | auto | 90 | 0.002189 | [gene_reports/etv6/report.md](gene_reports/etv6/report.md) |
| FLI1 | FDR-significant | auto | 118 | 0.007702 | [gene_reports/fli1/report.md](gene_reports/fli1/report.md) |
| RET | Honorable mention; Curated gene config | curated | 194 | 0.09074 | [gene_reports/ret/report.md](gene_reports/ret/report.md) |
| FGFR2 | Honorable mention | auto | 136 | 0.09074 | [gene_reports/fgfr2/report.md](gene_reports/fgfr2/report.md) |
| ALK | Honorable mention; Curated gene config | curated | 272 | 0.2116 | [gene_reports/alk/report.md](gene_reports/alk/report.md) |
| EGFR | Honorable mention | auto | 55 | 0.2368 | [gene_reports/egfr/report.md](gene_reports/egfr/report.md) |
| BRAF | Honorable mention; Curated gene config | curated | 179 | 0.2116 | [gene_reports/braf/report.md](gene_reports/braf/report.md) |
| FGFR3 | Honorable mention | auto | 152 | 0.2116 | [gene_reports/fgfr3/report.md](gene_reports/fgfr3/report.md) |
| CDKN2B | Honorable mention | auto | 12 | 0.3606 | [gene_reports/cdkn2b/report.md](gene_reports/cdkn2b/report.md) |
| NTRK1 | Honorable mention; Curated gene config | curated | 78 | 0.2116 | [gene_reports/ntrk1/report.md](gene_reports/ntrk1/report.md) |
| INPPL1 | Honorable mention | auto | 14 | 0.4733 | [gene_reports/inppl1/report.md](gene_reports/inppl1/report.md) |
| CDK12 | Honorable mention | auto | 43 | 0.2116 | [gene_reports/cdk12/report.md](gene_reports/cdk12/report.md) |
| NAB2 | Honorable mention | auto | 72 | 0.2116 | [gene_reports/nab2/report.md](gene_reports/nab2/report.md) |
| KDM5A | Honorable mention | auto | 10 | 0.8816 | [gene_reports/kdm5a/report.md](gene_reports/kdm5a/report.md) |
| FH | Honorable mention | auto | 16 | 0.673 | [gene_reports/fh/report.md](gene_reports/fh/report.md) |
| FGFR1 | Honorable mention | auto | 23 | 0.5489 | [gene_reports/fgfr1/report.md](gene_reports/fgfr1/report.md) |
| POLD1 | Honorable mention | auto | 16 | 0.2116 | [gene_reports/pold1/report.md](gene_reports/pold1/report.md) |
